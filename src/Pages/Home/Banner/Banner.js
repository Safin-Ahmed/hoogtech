...
const Banner = () => {
    return (
        <div className="banner-section pt-20 pb-5">
            <div className="container mx-auto text-center md:text-left banner-row flex flex-wrap items-center">
                <div className="banner-content w-full md:w-1/2">
                    <h1 className="text-3xl md:text-6xl font-bold">
                        ...
                        <span className="font-medium text-2xl md:text-4xl">IN THE NETHERLANDS</span>
                    </h1>
                    <p className="text-lg md:mx-0 mx-auto md:w-2/3 mt-5 mb-14">At HoogTech™ we put you first. Our products are of  high quality and made of robust materials. You have always had a cancellation period of 30 days for all your purchases.</p>
                ...
                <div className="banner-slider w-full md:w-1/2">
