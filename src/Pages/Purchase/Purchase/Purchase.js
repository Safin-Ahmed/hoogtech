...
const Purchase = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://hoogtech-server.up.railway.app/orders", {
      method: "POST",
      headers: {
      ...
      <div className="container py-10 flex flex-col-reverse md:flex-row flex-wrap mx-auto items-center">
        <div className="purchase-form w-full md:w-1/2">
          ...
          >
            ...
            <div className="mt-2">
              <label className=" block text-sm text-gray-600" for="cus_address">
                Address
              </label>
              <input
                onBlur={handleOnBlur}
            ...
            <div className="mt-4">
              <button
                className="px-4 py-1 text-white font-light tracking-wider primary-bg rounded"
                type="submit"
              >
                Place Order
              </button>
