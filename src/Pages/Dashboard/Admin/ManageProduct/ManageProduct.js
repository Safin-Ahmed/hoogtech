...
const ManageProduct = ({ product, setProducts }) => {
    ...
    const handleDelete = () => {
        const url = `https://safe-wildwood-94267.herokuapp.com/products?id=${_id}`;
            ...
            <div class="flex mb-10 max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="w-2/3 p-4">
                    ...
                    <div class="flex item-center justify-between mt-3">
                        ...
                        <button onClick={handleDelete} class="px-3 py-2 bg-red-500 text-white text-xs font-bold uppercase rounded">X</button>
                    </div>
                </div>
            </div>
        </div>
